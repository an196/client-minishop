	...
	return (
		<div>
			<div className='flex gap-10 m-10 mt-14 text-[#324d67]  font-semibold hlg:flex-wrap md:gap-6 sm:m-8 ssm:m-4'>
				<div>
					<div className='rounded-2xl bg-[#ebebeb] w-[360px] h-[360px] cursor-pointer duration-300 ease-in-out hover:bg-[#f02d34] md:w-[300px] md:h-[300px] 
				...
				<div className=''>
					...
					<div className='flex gap-5 mt-5 items-center hsm:gap-2 hsm:flex-wrap'>
						...
						<p className='border-1 border-gray-700 flex mt-1 rounded-xl'>
							<span className='text-base py-1 px-3 border-r-1 border-gray-700 text-[#f02d34] cursor-pointer hover:bg-[#f02d34]/10 rounded-l-sm' onClick={decQty}>
								<AiOutlineMinus />
							</span>
							<span className='py-1 px-3 border-r-1 border-gray-700 text-xs'>{qty}</span>
							<span className='text-base py-1 px-3 plus text-[#31a831]  cursor-pointer hover:bg-[#31a831]/10 rounded-r-sm' onClick={incQty}>
								<AiOutlinePlus />
							</span>
						</p>
					</div>
