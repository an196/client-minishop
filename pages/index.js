...
import OrtherCategory from '../components/OrtherCategory';
		...
		<>
			...
			<div>
				<div className='text-center my-[40px] mx-0 text-[#324d67]'>
					<h2 className='text-[40px] font-extrabold md:text-[32px] sm:text-[24px] ssm:text-[18px]'>
