	...
	return (
		<>
			<Link href={`/product/${product?._id}`}>
				<div
					className={`cursor-pointer duration-500 ease-linear  text-[#324d67] hover:scale-105 sm:space-y-1 sm:leading-3 items-stretch
					${minWidth ? `min-w-[${minWidth}] md:min-w-[150px] sm:min-w-[20vw]` : ''}
				`}
				>
					<div
						className='rounded-[15px] bg-[#ebebeb]  duration-400 ease-linear w-[200px] h-[200px] overflow-hidden relative
						 md:h-[150px]  md:w-[150px] sm:w-[20vw] sm:h-[20vw] hsm:w-[20vw] hsm:h-[20vw] '
					>
						<Image src={product.image[0] || fallbackImage} layout='fill' />
					</div>
					<div
						className='duration-400 ease-linear w-[200px]  flex flex-wrap flex-col 
						  md:w-[150px] sm:w-[20vw] hsm:w-[20vw]'
					>
