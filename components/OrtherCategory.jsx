...
function OrtherCategory() {
	return (
		<div className=''>
			...
			<div className='flex gap-4 hlg:grid hlg:grid-cols-2 hlg:place-items-center sm:gap-1 m-1 ssm:grid-cols-1'>
				{images.map((image) => (
					<div className='relative group w-[25%] h-[340px] xl:h-[260px] lg:h-[240px] md:h-[240px] hlg:w-full hlg:h-[32vh] sm:h-[22vh]  rounded-md overflow-hidden'>
						<Image src={image} alt='dsd' layout='fill' objectFit='center'  />
						<div className='absolute w-full h-[340px] xl:h-[260px] lg:h-[240px] hlg:h-[32vh] sm:h-[22vh] bg-[#3d3d3d]/60 !z-10 '></div>
